{{-- Thai DatePicker: patched from Filament's date-time-picker.blade.php --}}
{{-- Changes marked with "THAI:" comments. Run `php bin/sync-view.php` to re-sync. --}}
@php
...
>
    ...
    >
        ...
        @else
            <div
                x-load
                x-load-src="{{ \Filament\Support\Facades\FilamentAsset::getAlpineComponentSrc('date-time-picker', 'phattarachai/filament-thai-date-picker') }}"
